...
function MessageBox({ profileSrc }) {
    ...
    const toggleMessageBox = () => {
        ...
        if (showMessageBox) {
            messageBoxElement.style.bottom = "-110px";
        } else {
        ...
        <>
            <div className="messageBox">
                <div className="messageUpperBox">
                    ...
                    <h6>Messaging</h6>
                    <div className="icons" style={{ width: "40%", display: "flex", justifyContent: "space-around", cursor: "pointer",}}>
                        <FontAwesomeIcon icon={faEllipsis} />
                        <FontAwesomeIcon icon={faPen} />
                        <FontAwesomeIcon icon={faChevronDown} onClick={toggleMessageBox} id="messageBoxPop" />
                    </div>
                </div>
